const elements = [
  // Main periodic table elements
    ...
    { number: 55, symbol: "Cs", name: "Caesium", group: 1, period: 6 },
  ...
  // Lanthanides (placed below the main table)
    { number: 58, symbol: "Ce", name: "Cerium", group: null, period: 8, isLanthanide: true },
    { number: 59, symbol: "Pr", name: "Praseodymium", group: null, period: 8, isLanthanide: true },
    { number: 60, symbol: "Nd", name: "Neodymium", group: null, period: 8, isLanthanide: true },
    { number: 61, symbol: "Pm", name: "Promethium", group: null, period: 8, isLanthanide: true },
    { number: 62, symbol: "Sm", name: "Samarium", group: null, period: 8, isLanthanide: true },
    { number: 63, symbol: "Eu", name: "Europium", group: null, period: 8, isLanthanide: true },
    { number: 64, symbol: "Gd", name: "Gadolinium", group: null, period: 8, isLanthanide: true },
    { number: 65, symbol: "Tb", name: "Terbium", group: null, period: 8, isLanthanide: true },
    { number: 66, symbol: "Dy", name: "Dysprosium", group: null, period: 8, isLanthanide: true },
    { number: 67, symbol: "Ho", name: "Holmium", group: null, period: 8, isLanthanide: true },
    { number: 68, symbol: "Er", name: "Erbium", group: null, period: 8, isLanthanide: true },
    { number: 69, symbol: "Tm", name: "Thulium", group: null, period: 8, isLanthanide: true },
    { number: 70, symbol: "Yb", name: "Ytterbium", group: null, period: 8, isLanthanide: true },
    { number: 71, symbol: "Lu", name: "Lutetium", group: null, period: 8, isLanthanide: true },

  // Actinides
  
    { number: 90, symbol: "Th", name: "Thorium", group: null, period: 9, isActinide: true },
    { number: 91, symbol: "Pa", name: "Protactinium", group: null, period: 9, isActinide: true },
    { number: 92, symbol: "U", name: "Uranium", group: null, period: 9, isActinide: true },
    { number: 93, symbol: "Np", name: "Neptunium", group: null, period: 9, isActinide: true },
    { number: 94, symbol: "Pu", name: "Plutonium", group: null, period: 9, isActinide: true },
    { number: 95, symbol: "Am", name: "Americium", group: null, period: 9, isActinide: true },
    { number: 96, symbol: "Cm", name: "Curium", group: null, period: 9, isActinide: true },
    { number: 97, symbol: "Bk", name: "Berkelium", group: null, period: 9, isActinide: true },
    { number: 98, symbol: "Cf", name: "Californium", group: null, period: 9, isActinide: true },
    { number: 99, symbol: "Es", name: "Einsteinium", group: null, period: 9, isActinide: true },
    { number: 100, symbol: "Fm", name: "Fermium", group: null, period: 9, isActinide: true },
    { number: 101, symbol: "Md", name: "Mendelevium", group: null, period: 9, isActinide: true },
    { number: 102, symbol: "No", name: "Nobelium", group: null, period: 9, isActinide: true },
    { number: 103, symbol: "Lr", name: "Lawrencium", group: null, period: 9, isActinide: true },
];
